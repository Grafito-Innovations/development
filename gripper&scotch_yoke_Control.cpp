...
#define MOTOR_AOUT (gpio_num_t)19
#define MOTOR_AIN (gpio_num_t)18
#define MOTOR_AOUT2 (gpio_num_t)4
#define MOTOR_AIN2 (gpio_num_t)13

// Define encoder pin assignments
#define ENCODER_A (gpio_num_t)34
#define ENCODER_B (gpio_num_t)35
...
double TimeInterval = 5.0;  // time interval in milliseconds
