...
#define SERVO_MAX_DEGREE        (135)   //90 - samll servo, 135 for larger servo// Maximum angle in degree upto which servo can rotate
...
void app_main(void)
{
    ...
    while (1) {
        ...
        // 115 for laege servo, 90 for small servo
            ESP_ERROR_CHECK(mcpwm_set_duty_in_us(MCPWM_UNIT_0, MCPWM_TIMER_0, MCPWM_OPR_A, example_convert_servo_angle_to_duty_us(-115)));
