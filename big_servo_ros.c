...
#define SERVO_MAX_DEGREE        (135)   // Maximum angle in degree upto which servo can rotate 

#define SERVO_PULSE_GPIO        (18)   // GPIO connects to the PWM signal line
rcl_subscription_t subscriber;
std_msgs__msg__Int32 recv_msg;
int servo_setpoint = 115; // intial original state we have to put (115 to fully close, -115 to fully open)
